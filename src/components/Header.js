            	...
            	<div className="container">
            		<nav className="navbar flex items-center" aria-label="Main Navigation">
            			...
            			<div className="navbar__branding mr-2">
            				...
            				<Link className="navbar__title h2 m-0" to={withPrefix('/')}>{_.get(this.props, 'pageContext.site.siteMetadata.header.title', null)}{text-decoration-color: white;
    background-color: rgb(14, 142, 226);}</Link>
            				}
            			</div>
